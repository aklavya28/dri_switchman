...
ActiveRecord::Schema[7.0].define(version: 2025_02_28_105536) do
  ...
  create_table "switchman_shards", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
